...
class FloatingShortcutsForTime : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, serviceStartId: Int): Int {
        ...
        Debug.PrintDebug(this@FloatingShortcutsForTime.javaClass.simpleName + " ::: StartId ::: " + serviceStartId)
        ...
        intent?.run {
                            ...
                            runnablePressHold = Runnable {
                                if (touchingDelay[startId]) {
                                    functionsClassLegacy.PopupOptionShortcuts(
                                            ...
                                            this@FloatingShortcutsForTime.javaClass.simpleName,
                                            startId,
                                            initialX,
                                            initialY
                                    )
                            ...
                            if (!AuthenticationProcess.authenticationProcessInvoked) {
                                ...
                                SecurityInterfaceHolder.authenticationCallback = object : AuthenticationCallback {
                                    ...
                                    override fun authenticatedFloatIt(extraInformation: Bundle?) {
                                        ...
                                        Log.d(this@FloatingShortcutsForTime.javaClass.simpleName, "AuthenticatedFloatingShortcuts")
                                    ...
                                    override fun failedAuthenticated() {
                                        ...
                                        Log.d(this@FloatingShortcutsForTime.javaClass.simpleName, "FailedAuthenticated")
                                    ...
                                    override fun invokedPinPassword() {
                                        ...
                                        Log.d(this@FloatingShortcutsForTime.javaClass.simpleName, "InvokedPinPassword")
            ...
            if (serviceStartId == 1) {
                val floatingShortcutClassInCommand: String = this@FloatingShortcutsForTime.javaClass.simpleName
                    ...
                    override fun onReceive(context: Context, intent: Intent) {
                        if (intent.action == "Split_Apps_Single_$floatingShortcutClassInCommand" && PublicVariable.splitScreen) {
                            ...
                            for (stickyCounter in 0 until floatingShortcutsBinding.size) {
                                ...
                                stickyEdgeParams.add(stickyCounter, functionsClassLegacy.moveToEdge(this@FloatingShortcutsForTime.packageNames.get(stickyCounter), layoutParams[stickyCounter].height))
                            ...
                            for (stickyCounter in 0 until floatingShortcutsBinding.size) {
                                ...
                                val sharedPreferencesPositionBroadcast = getSharedPreferences(this@FloatingShortcutsForTime.packageNames[stickyCounter], Context.MODE_PRIVATE)
