...
public class FloatingShortcutsForGps extends Service {
    ...
    public int onStartCommand(final Intent intent, final int flags, final int startId) {
                            ...
                            public void run() {
                                if (touchingDelay[startId] == true) {
                                    functionsClass.PopupOptionShortcuts(
                                            ...
                                            packages[startId],
                                            FloatingShortcutsForGps.class.getSimpleName(),
                                            startId,
                                            initialX,
        ...
        final String className = FloatingShortcutsForGps.class.getSimpleName();
