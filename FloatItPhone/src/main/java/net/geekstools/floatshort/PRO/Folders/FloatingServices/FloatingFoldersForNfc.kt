...
class FloatingFoldersForNfc : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, serviceStartId: Int): Int {
        ...
        Debug.PrintDebug(this@FloatingFoldersForNfc.javaClass.simpleName + " ::: StartId ::: " + serviceStartId)
                    ...
                    override fun onReceive(context: Context, intent: Intent) {
                        ...
                        if (intent.action == "Split_Apps_Pair_$floatingFolderClassInCommand" && PublicVariable.splitScreen) {
                            ...
                            for (stickyCounter in 0 until floatingView.size) {
                                ...
                                stickyEdgeParams.add(stickyCounter, functionsClassLegacy.moveToEdge(this@FloatingFoldersForNfc.folderName.get(stickyCounter), layoutParams[stickyCounter].height))
