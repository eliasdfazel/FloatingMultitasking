...
class FloatingFoldersForNfc : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, serviceStartId: Int): Int {
        ...
        FunctionsClassDebug.PrintDebug(this@FloatingFoldersForNfc.javaClass.simpleName + " ::: StartId ::: " + serviceStartId)
        ...
        intent?.run {
            ...
            if (this@run.hasExtra(getString(R.string.remove_all_floatings))) {
                if (this@run.getStringExtra(getString(R.string.remove_all_floatings)) == getString(R.string.remove_all_floatings)) {
                    ...
                    FloatingFoldersUtils.floatingFoldersCounterType[this@FloatingFoldersForNfc.javaClass.simpleName] = -1
                            ...
                            runnablePressHold = Runnable {
                                ...
                                if (touchingDelay[startId]) {
                                    ...
                                    functionsClass.PopupOptionFolder(
                                            view,
                                            folderName[startId],
                                            this@FloatingFoldersForNfc.javaClass.simpleName,
                                            startId,
                                            initialX,
            ...
            if (serviceStartId == 1) {
                val floatingFolderClassInCommand: String = this@FloatingFoldersForNfc.javaClass.simpleName
                        ...
                        if (intent.action == "Split_Apps_Pair_$floatingFolderClassInCommand" && PublicVariable.splitScreen) {
                            ...
                            if (floatingView[intent.getIntExtra("startId", 0)].isShown) {
                                try {
                                    ...
                                    floatingFoldersUtils.floatingFoldersCounterType(this@FloatingFoldersForNfc.javaClass.simpleName)
                                    ...
                                    if (floatingFoldersCounterType[this@FloatingFoldersForNfc.javaClass.getSimpleName()] == 0) {
                            ...
                            for (stickyCounter in 0 until floatingView.size) {
                                ...
                                stickyEdgeParams.add(stickyCounter, functionsClass.moveToEdge(this@FloatingFoldersForNfc.folderName.get(stickyCounter), layoutParams[stickyCounter].height))
                            ...
                            for (stickyCounter in 0 until floatingView.size) {
                                ...
                                val sharedPreferencesPositionBroadcast = getSharedPreferences(this@FloatingFoldersForNfc.folderName[stickyCounter], Context.MODE_PRIVATE)
