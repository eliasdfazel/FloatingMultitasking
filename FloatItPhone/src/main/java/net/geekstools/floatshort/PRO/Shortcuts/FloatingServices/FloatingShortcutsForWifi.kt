...
class FloatingShortcutsForWifi : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, serviceStartId: Int): Int {
        ...
        Debug.PrintDebug(this@FloatingShortcutsForWifi.javaClass.simpleName + " ::: StartId ::: " + serviceStartId)
        ...
        intent?.run {
                            ...
                            runnablePressHold = Runnable {
                                if (touchingDelay[startId]) {
                                    functionsClassLegacy.PopupOptionShortcuts(
                                            ...
                                            this@FloatingShortcutsForWifi.javaClass.simpleName,
                                            startId,
                                            initialX,
                                            initialY
                                    )
                            ...
                            if (!AuthenticationProcess.authenticationProcessInvoked) {
                                ...
                                SecurityInterfaceHolder.authenticationCallback = object : AuthenticationCallback {
                                    ...
                                    override fun authenticatedFloatIt(extraInformation: Bundle?) {
                                        ...
                                        Log.d(this@FloatingShortcutsForWifi.javaClass.simpleName, "AuthenticatedFloatingShortcuts")
                                    ...
                                    override fun failedAuthenticated() {
                                        ...
                                        Log.d(this@FloatingShortcutsForWifi.javaClass.simpleName, "FailedAuthenticated")
                                    ...
                                    override fun invokedPinPassword() {
                                        ...
                                        Log.d(this@FloatingShortcutsForWifi.javaClass.simpleName, "InvokedPinPassword")
            ...
            if (serviceStartId == 1) {
                val floatingShortcutClassInCommand: String = this@FloatingShortcutsForWifi.javaClass.simpleName
                    ...
                    override fun onReceive(context: Context, intent: Intent) {
                        if (intent.action == "Split_Apps_Single_$floatingShortcutClassInCommand" && PublicVariable.splitScreen) {
                            ...
                            for (stickyCounter in 0 until floatingShortcutsBinding.size) {
                                ...
                                stickyEdgeParams.add(stickyCounter, functionsClassLegacy.moveToEdge(this@FloatingShortcutsForWifi.packageNames.get(stickyCounter), layoutParams[stickyCounter].height))
