...
public class FloatingShortcutsForWifi extends Service {
    ...
    public int onStartCommand(final Intent intent, final int flags, final int startId) {
                            ...
                            public void run() {
                                if (touchingDelay[startId] == true) {
                                    functionsClass.PopupOptionShortcuts(
                                            ...
                                            packages[startId],
                                            FloatingShortcutsForWifi.class.getSimpleName(),
                                            startId,
                                            initialX,
        ...
        final String className = FloatingShortcutsForWifi.class.getSimpleName();
