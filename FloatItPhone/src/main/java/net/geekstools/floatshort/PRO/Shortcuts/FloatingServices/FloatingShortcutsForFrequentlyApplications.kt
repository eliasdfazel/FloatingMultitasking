                                ...
                                try {
                                    if (floatingShortcutsBinding.get(removeCount).root.isShown) {
                                        try {
                                            ...
                                            stickyEdgeParams[removeCount] = functionsClass.moveToEdge(this@FloatingShortcutsForFrequentlyApplications.packageNames.get(removeCount), layoutParams[removeCount].height)
