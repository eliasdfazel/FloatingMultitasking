...
class FloatingShortcutsForNfc : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, serviceStartId: Int): Int {
        ...
        FunctionsClassDebug.PrintDebug(this@FloatingShortcutsForNfc.javaClass.simpleName + " ::: StartId ::: " + serviceStartId)
        ...
        intent?.run {
                            ...
                            runnablePressHold = Runnable {
                                if (touchingDelay[startId]) {
                                    functionsClass.PopupOptionShortcuts(
                                            ...
                                            this@FloatingShortcutsForNfc.javaClass.simpleName,
                                            startId,
                                            initialX,
                                            initialY
                                    )
                            ...
                            if (!AuthenticationProcess.authenticationProcessInvoked) {
                                ...
                                SecurityInterfaceHolder.authenticationCallback = object : AuthenticationCallback {
                                    ...
                                    override fun authenticatedFloatIt(extraInformation: Bundle?) {
                                        ...
                                        Log.d(this@FloatingShortcutsForNfc.javaClass.simpleName, "AuthenticatedFloatingShortcuts")
                                    ...
                                    override fun failedAuthenticated() {
                                        ...
                                        Log.d(this@FloatingShortcutsForNfc.javaClass.simpleName, "FailedAuthenticated")
                                    ...
                                    override fun invokedPinPassword() {
                                        ...
                                        Log.d(this@FloatingShortcutsForNfc.javaClass.simpleName, "InvokedPinPassword")
            ...
            if (serviceStartId == 1) {
                val floatingShortcutClassInCommand: String = this@FloatingShortcutsForNfc.javaClass.simpleName
                    ...
                    override fun onReceive(context: Context, intent: Intent) {
                        if (intent.action == "Split_Apps_Single_$floatingShortcutClassInCommand" && PublicVariable.splitScreen) {
                            ...
                            for (stickyCounter in 0 until floatingShortcutsBinding.size) {
                                ...
                                stickyEdgeParams.add(stickyCounter, functionsClass.moveToEdge(this@FloatingShortcutsForNfc.packageNames.get(stickyCounter), layoutParams[stickyCounter].height))
                            ...
                            for (stickyCounter in 0 until floatingShortcutsBinding.size) {
                                ...
                                val sharedPreferencesPositionBroadcast = getSharedPreferences(this@FloatingShortcutsForNfc.packageNames[stickyCounter], Context.MODE_PRIVATE)
