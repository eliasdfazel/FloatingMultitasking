 ...
 * Last modified 11/11/20 10:44 AM
 *
...
class FloatingFoldersForGps : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, serviceStartId: Int): Int {
        ...
        Debug.PrintDebug(this@FloatingFoldersForGps.javaClass.simpleName + " ::: StartId ::: " + serviceStartId)
        ...
        intent?.run {
            ...
            if (this@run.hasExtra(getString(R.string.remove_all_floatings))) {
                if (this@run.getStringExtra(getString(R.string.remove_all_floatings)) == getString(R.string.remove_all_floatings)) {
                    ...
                    FloatingFoldersUtils.floatingFoldersCounterType[this@FloatingFoldersForGps.javaClass.simpleName] = -1
            ...
            if (serviceStartId == 1) {
                val floatingFolderClassInCommand: String = this@FloatingFoldersForGps.javaClass.simpleName
                        ...
                        if (intent.action == "Split_Apps_Pair_$floatingFolderClassInCommand" && PublicVariable.splitScreen) {
                            ...
                            if (floatingView[intent.getIntExtra("startId", 0)].isShown) {
                                try {
                                    ...
                                    floatingFoldersUtils.floatingFoldersCounterType(this@FloatingFoldersForGps.javaClass.simpleName)
                                    ...
                                    if (floatingFoldersCounterType[this@FloatingFoldersForGps.javaClass.getSimpleName()] == 0) {
                            ...
                            for (stickyCounter in 0 until floatingView.size) {
                                ...
                                stickyEdgeParams.add(stickyCounter, functionsClassLegacy.moveToEdge(this@FloatingFoldersForGps.folderName.get(stickyCounter), layoutParams[stickyCounter].height))
                            ...
                            for (stickyCounter in 0 until floatingView.size) {
                                ...
                                val sharedPreferencesPositionBroadcast = getSharedPreferences(this@FloatingFoldersForGps.folderName[stickyCounter], Context.MODE_PRIVATE)
