...
class FloatingFoldersForGps : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, serviceStartId: Int): Int {
        ...
        FunctionsClassDebug.PrintDebug(this@FloatingFoldersForGps.javaClass.simpleName + " ::: StartId ::: " + serviceStartId)
                    ...
                    override fun onReceive(context: Context, intent: Intent) {
                        ...
                        if (intent.action == "Split_Apps_Pair_$floatingFolderClassInCommand" && PublicVariable.splitScreen) {
                            ...
                            for (stickyCounter in 0 until floatingView.size) {
                                ...
                                stickyEdgeParams.add(stickyCounter, functionsClass.moveToEdge(this@FloatingFoldersForGps.folderName.get(stickyCounter), layoutParams[stickyCounter].height))
