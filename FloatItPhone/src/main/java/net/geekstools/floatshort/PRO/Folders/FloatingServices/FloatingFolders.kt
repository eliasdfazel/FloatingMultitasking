 ...
 * Last modified 10/15/20 10:41 AM
 *
                    ...
                    override fun onReceive(context: Context, intent: Intent) {
                        ...
                        if (intent.action == "Split_Apps_Pair_$floatingFolderClassInCommand" && PublicVariable.splitScreen) {
                            ...
                            for (stickyCounter in 0 until floatingView.size) {
                                ...
                                stickyEdgeParams.add(stickyCounter, functionsClassLegacy.moveToEdge(this@FloatingFolders.folderName.get(stickyCounter), layoutParams[stickyCounter].height))
                            ...
                            for (stickyCounter in 0 until floatingView.size) {
                                ...
                                val sharedPreferencesPositionBroadcast = getSharedPreferences(this@FloatingFolders.folderName[stickyCounter], Context.MODE_PRIVATE)
