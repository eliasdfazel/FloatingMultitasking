 ...
 * Last modified 4/24/20 11:24 AM
 *
                    ...
                    override fun onReceive(context: Context, intent: Intent) {
                        ...
                        if (intent.action == "Split_Apps_Pair_$floatingFolderClassInCommand" && PublicVariable.splitScreen) {
                            ...
                            for (stickyCounter in 0 until floatingView.size) {
                                ...
                                stickyEdgeParams.add(stickyCounter, functionsClass.moveToEdge(this@FloatingFolders.folderName.get(stickyCounter), layoutParams[stickyCounter].height))
